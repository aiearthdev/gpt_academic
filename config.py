...
API_KEY = ""    # 可同时填写多个API-KEY，用英文逗号分割，例如API_KEY = "sk-openaikey1,sk-openaikey2,fkxxxx-api2dkey3,azure-apikey4"
...
AVAIL_LLM_MODELS = ["gpt-4-all","gpt-4-turbo-all","gpt-4-0125-preview","gpt-4-1106-preview","gpt-3.5-turbo-1106","gpt-4-vision-preview",
