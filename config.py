...
API_URL_REDIRECT = {"https://api.openai.com/v1/chat/completions": "https://api-aiearth.zeabur.app/v1/chat/completions"}
...
AVAIL_LLM_MODELS = ["gpt-4-all", "gpt-4-turbo-all", "gpt-4-1106-preview", "gpt-4-turbo-preview", "gpt-4-vision-preview",
